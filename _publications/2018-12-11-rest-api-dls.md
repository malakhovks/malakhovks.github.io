...
citation: 'Malakhov, K., Kurgaev, O., Velychko, V. (2018). Modern RESTful API DLs and frameworks for RESTful web services API schema modeling, documenting, visualizing <i>Problems of programming, 4</i>, 59–68. Retrieved from http://pp.isofts.kiev.ua/ojs1/article/view/335'
---
